...
release: package doc ## Create a release on GitHub
	...
	@gh release create v$(VERSION) "$(BINNAME)-$(VERSION).tar.gz" --generate-notes --notes-from-tag --title "$(VERSION)" --notes "Release $(VERSION), view changelogs in [CHANGELOG.md](https://github.com/LitFill/rpg-tutorial/blob/main/CHANGELOG.md)"
